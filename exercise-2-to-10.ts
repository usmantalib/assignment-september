...
var message: string = "Taking pains to remove the pains of others is the true essence of generosity.";
var famous_person: string = "Abu Bakr (R.A)";
...
var person_name:string = "\t\t\tUsman Talib\n\n\n";
...
var favorite_number:number = 8; //Declared number type variable
var message: string= `My favorite number is ${favorite_number}`; // Declared string type variable and Concatenated the number variable in the string
